...
const INSTALLER_PATH_DARWIN = "Solari.app/Contents/MacOS/Solari";
const INSTALLER_APP_DARWIN = "Solari.app";
...
function getFilename() {
    switch (process.platform) {
        ...
        case "darwin":
            switch (process.arch) {
                case "x64":
                    return "Solari-darwin-x64.zip";
                case "arm64":
                    return "Solari-darwin-arm64.zip";
                default:
